...
the\da[]{Perhaps it's ''a" not "the". I recall Sage commenting on $D$ not being
uniquely defined if $D$ has a boundary?}
...
one. That depends on how weights are calculated, and on the function space of $v$, I
believe. If possible, we should say something
about the expected convergence rate of $|Qv - Q_nv|$.} We are now ready to specify a
