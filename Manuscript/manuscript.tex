...
$\Xi = \{ x_i \}_{i \in \NSet_n} \subset D$. \da[]{I have used $\NSet_n = \{ 1,\ldots,n
\}$. I also dislike $\Xi$, we can change it later} In what follows, it may be useful to make $n$ depend on a positive real number
...
\da[inline]{This section can be skipped at a first pass}
