...
if SAVE:
    ...
    plotter.screenshot("media/torus.png")
else:
    plotter.show()
...
if SAVE:
    ...
    plotter.screenshot("media/torus_flat_triangles.png")
else:
    plotter.show()
...
if SAVE:
    ...
    plotter.screenshot("media/torus_over_flat_triangles.png")
else:
    plotter.show()
...
if SAVE:
    ...
    plotter.screenshot("media/torus_partition.png")
else:
    plotter.show()
...
if SAVE:
    ...
    plotter.screenshot("media/torus_bad_partition.png")
else:
    plotter.show()
