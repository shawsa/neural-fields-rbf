...
SPHERE_CONVERGENCE_DATA_FILE = (
    "convergence_on_multiple_geometries/data/sphere_convergence.json"
)
SPHERE_NODES_IMAGE_FILE = (
    "convergence_on_multiple_geometries/media/icosahedral_nodes.png"
)
plt.rcParams.update(
    {
        "font.size": 12,
...
with open(SPHERE_NODES_IMAGE_FILE, "rb") as f:
    image = plt.imread(f)
...
plt.show()
plt.savefig("media/sphere_quad_convergence.pdf")
